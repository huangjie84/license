...
public abstract class AbstractServerInfo {
    ...
    protected List<String> getLocalMacInfo() {
        ...
        try {
            ...
            List<String> realMacName = getLocalMacRealName();
            while (em.hasMoreElements()) {
                ...
                if (realMacName != null && !realMacName.contains(anInterface.getName())){
                    continue;
                }
                if(anInterface.isLoopback() && anInterface.isPointToPoint() && anInterface.isVirtual()){
                    log.info("==>this is address us loop address");
                }
    ...
    protected abstract List<String> getLocalMacRealName () throws Exception;
