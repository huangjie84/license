 ...
 * Client applications should use this class to implement the interfaces in order to
...
//            System.out.println(obfuscate(args[i]));
        System.out.println(obfuscate("TransferLicenseKey@Orcadt"));
    ...
    public static String obfuscate(final String s) {
        ...
        final StringBuffer code = new StringBuffer(new ObfuscatStringUtil(new long[] {
                0x8F02EBEB2BF5BA82L, 0x92F171D02CE79BB8L, 0x5DB76AE9189E5577L,
                0xB268CB8B37C85CB4L, 0xB3BF3FE6B07D0A46L, 0x6A6EA2FDDC281D22L
